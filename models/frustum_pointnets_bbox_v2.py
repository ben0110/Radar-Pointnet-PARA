...
from model_util import placeholder_inputs_bbox, parse_output_to_tensors, get_loss_batch,get_loss_bbox
...
def get_model(point_cloud,mask_xyz_mean, one_hot_vec, is_training, bn_decay=None):
    ...
    object_point_cloud_xyz_new = \
        point_cloud - tf.expand_dims(center_delta, 1)
