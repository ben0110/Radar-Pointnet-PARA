...
from train_util import get_batch_seg,get_batch_bbox
...
TEST_DATASET = provider.RadarDataset_seg('pc_radar_2','KITTI',npoints=NUM_POINT, split='val',rotate_to_center=False, one_hot=True,all_batches = True, translate_radar_center=False, store_data=True, proposals_3 =False ,no_color=True)
...
def inference_seg(sess, ops, pc, one_hot_vec, batch_size):
...
def test(output_filename, result_dir=None):
    ...
    for batch_idx in range(num_batches):
        ...
        preds_val,  batch_seg_scores = \
            inference_seg(sess_seg, ops_seg, batch_data,
